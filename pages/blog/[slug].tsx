        ...
        <div>
          <div className="px-6 py-16 pb-48 mx-auto -mb-48 text-center bg-gray-100 md:pb-96 md:-mb-96 dark:bg-gray-900">
            <div className="max-w-3xl mx-auto">
              ...
              <div className="font-extrabold tracking-tight text-gray-900 dark:text-gray-100 text-3xl">
                {title}
              </div>
              <div className="max-w-3xl mx-auto mt-2 leading-8 text-gray-500 dark:text-gray-400 sm:mt-2 ">
                {summary}
              </div>
            </div>
          </div>
